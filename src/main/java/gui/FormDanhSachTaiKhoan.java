 ...
 * @author Admin
 */
public class FormDanhSachTaiKhoan extends javax.swing.JPanel {
...
//        tbl_danhSachNhanVien.getTableHeader()
    ...
    private void initComponents() {
        ...
        tbl_DanhSachTaiKhoan.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        ...
        lbl_TimKiem.setFont(new java.awt.Font("Calibri", 0, 14)); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(18, 18, 18)
                .addComponent(lbl_TimKiem, javax.swing.GroupLayout.PREFERRED_SIZE, 118, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        lbl_TentaiKhoan.setFont(new java.awt.Font("sansserif", 0, 14)); // NOI18N
        lbl_TentaiKhoan.setText("Tên tài khoản:");

        txt_TenTaiKhoan.setFont(new java.awt.Font("sansserif", 0, 14)); // NOI18N
        ...
        lbl_MatKhau.setFont(new java.awt.Font("sansserif", 0, 14)); // NOI18N
        lbl_MatKhau.setText("Mật khẩu:");

        txt_MatKhau.setFont(new java.awt.Font("sansserif", 0, 14)); // NOI18N

        lbl_LoaitaiKhoan.setFont(new java.awt.Font("sansserif", 0, 14)); // NOI18N
        lbl_LoaitaiKhoan.setText("Loại tài khoản:");

        txt_LoaiTaiKhoan.setFont(new java.awt.Font("sansserif", 0, 14)); // NOI18N

        lbl_MaNhanVien.setFont(new java.awt.Font("sansserif", 0, 14)); // NOI18N
        lbl_MaNhanVien.setText("Mã nhân viên:");

        txt_MaNhanVien.setFont(new java.awt.Font("sansserif", 0, 14)); // NOI18N

        lbl_TenNhanVien.setFont(new java.awt.Font("sansserif", 0, 14)); // NOI18N
        lbl_TenNhanVien.setText("Tên nhân viên:");

        txt_TenNhanVien.setFont(new java.awt.Font("sansserif", 0, 14)); // NOI18N

        lbl_ChucVu.setFont(new java.awt.Font("sansserif", 0, 14)); // NOI18N
        lbl_ChucVu.setText("Chức vụ:");

        txt_ChucVu.setFont(new java.awt.Font("sansserif", 0, 14)); // NOI18N

        btn_DatMatKhauMacDinh.setFont(new java.awt.Font("sansserif", 0, 14)); // NOI18N
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txt_TenTaiKhoan, javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(txt_MatKhau, javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(txt_LoaiTaiKhoan, javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(txt_MaNhanVien, javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(txt_TenNhanVien, javax.swing.GroupLayout.Alignment.TRAILING)
    ...
    private void tblDanhSachTaiKhoan() {
        ...
        clearTable();
        DefaultTableModel dtm = (DefaultTableModel) tbl_DanhSachTaiKhoan.getModel();
        ArrayList<TaiKhoan> listTaiKhoan = taiKhoanDao.getAllTaiKhoan();
        for (TaiKhoan taiKhoan : listTaiKhoan) {
            Object[] rowData = {taiKhoan.getTenTaiKhoan(), taiKhoan.getNhanVien().getHoVaTen(), taiKhoan.getLoaiTaiKhoan() == true ? "Quản lý" : "Nhân viên"};
            dtm.addRow(rowData);
        }
